...
\begin{table}[ht]
  \begin{tabular}{|m{4cm}|m{3cm}|m{4cm}|m{3cm}|}
    \hline
    \includegraphics[scale=0.2]{noninvertingamp} &
    $= ( 1 + \frac{R_2}{R_1}V_{\text{in}})$ &
    \includegraphics[scale=0.3]{voltagefollower} &
    $= V_{\text{in}}$ \\
    \hline
    \includegraphics[scale=0.25]{invertingamp} &
    $= -\frac{R_2}{R_1}V_{\text{in}}$ &
    \includegraphics[scale=0.3]{subtractor} &
    $= \frac{R_2}{R_1}(V_2 - V_1)$ \\
    \hline
    \includegraphics[scale=0.25]{invertingsumming} &
    $= -\frac{R_2}{R_1}(V_1+V_2)$ &
    \includegraphics[scale=0.3]{noninveringsumming} &
    $= V_1 + V_2$ \\
    \hline
  \end{tabular}
\end{table}

\includegraphics[scale=0.5]{opampvoltagedivider}
