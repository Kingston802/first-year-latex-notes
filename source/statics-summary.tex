...
\marginnote{\includegraphics[scale=0.04]{4}}
\begin{center}
\begin{gather*}
...
\marginnote{\includegraphics[scale=0.15]{topic-3}}
\begin{gather*}
    F_{2x} = 2\cos{30} \\ 
    F_{2y} = 2\sin{30} \\
    F_{4x} = 0 \\ 
...
\marginnote{\includegraphics[scale=0.05]{triangle}}[1.8cm]
...
\subsection{Example}
\begin{example*}
  \marginnote{\includegraphics[scale=0.15]{centroids}}
\begin{equation*}
\begin{gathered}
